        ...
        <div>
            <div className="font-sans">
                ...
                <section
                    ...
                    style={{
                        backgroundImage:
                            "url('https://www.car-rentalssdubai.com/public/images/2000x600_1.jpg')",
                    }}
                >
                ...
                <section
                    ...
                    style={{
                        backgroundImage:
                            "url('https://www.car-rentalssdubai.com/public/images/1s.jpg')",
                    }}
                >
                    <div className="bg-black/40 absolute inset-0"></div>
                    <div className="relative z-10">
                ...
                <section
                    ...
                    style={{
                        backgroundImage:
                            "url('https://www.car-rentalssdubai.com/public/images/3s.jpg')",
                    }}
                >
                    <div className="bg-black/40 absolute inset-0"></div>
                    <div className="relative z-10">
                ...
                <section className="py-12 bg-white text-center">
                    ...
                    <div className="flex flex-wrap justify-center items-center gap-6">
                        <LazyLoadImage src="https://www.car-rentalssdubai.com/common/cms_image/554/0/0/1" alt="WorldPay" className="h-13" />
                        <LazyLoadImage src="https://www.car-rentalssdubai.com/common/cms_image/555/0/0/1" alt="Dubai" className="h-13" />
                        <LazyLoadImage src="https://www.car-rentalssdubai.com/common/cms_image/604/0/0/1" alt="SSL" className="h-13" />
                        <LazyLoadImage src="https://www.car-rentalssdubai.com/common/cms_image/557/0/0/1" alt="Tripadvisor" className="h-13" />
                        <LazyLoadImage src="https://www.car-rentalssdubai.com/common/cms_image/567/0/0/1" alt="Trustpilot" className="h-13" />
                    </div>
                </section>
