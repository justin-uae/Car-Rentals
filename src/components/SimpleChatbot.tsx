...
const FAQ_DATABASE: Record<string, string> = {
    'hello': 'Hello! 👋 Welcome to Dubai car-rentalss. How can I help you today?',
    'hi': 'Hi there! 👋 I can help you with information about our Dubai tours and fleets.',
    'price': '💰 **Tour Pricing**\n\n• Burj Khalifa: from **AED 150**\n• Desert Safari: from **AED 280**\n• Marina Cruise: from **AED 250**\n• Abu Dhabi Tour: from **AED 350**\n\n[View All Tours](/fleets)',
    'cost': '💰 Our fleets range from **AED 150 to AED 900** depending on the tour.\n\n[View All Tours](/fleets)',
    'booking': '📱 **Easy Booking Process**\n\n1️⃣ Browse our fleets\n2️⃣ Select your tour\n3️⃣ Choose date & guests\n4️⃣ Add to cart & checkout\n\n✅ Secure payment\n✅ Instant confirmation\n\n[Start Booking](/fleets)',
    'book': '📝 You can book directly on our website!\n\n[Browse car-rentalss](/fleets)\n\nOr contact us on WhatsApp for assistance! 💬',
    ...
    'time': '⏰ Tour times vary by car-rentals. Most tours include flexible pickup times.\n\nCheck individual tour pages for specific timings!',
...
function findAnswer(question: string): string {
    ...
    const priorityMatches: Array<[string[], string]> = [
        ...
        [['tour', 'car-rentals', 'trip', 'show'], 'price'], // Default to show tours
    ];
...
export function SimpleChatbot() {
    ...
    const [messages, setMessages] = useState<Message[]>([
        {
            role: 'assistant',
            content: 'Hello! 👋 Welcome to **Dubai car-rentalss**.\n\n**I can help you with:**\n• Tour information\n• Pricing\n• Booking process\n• Pickup details\n• Contact information\n\nWhat would you like to know?',
            timestamp: new Date(),
        }
    ]);
